...
<label><b>Location</b></label>
    <form:input type="text" placeholder="Enter Location" name="psw" path="location" />

<label><b>City</b></label>
    <form:input type="text" placeholder="Enter City" name="psw" path="city" />

<label><b>Country</b></label>
    <form:input type="text" placeholder="Enter State" name="psw" path="state" />
